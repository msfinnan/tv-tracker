...
export const PRIORITY_OPTIONS: { value: number; label: string; shortLabel: string }[] = [
  { value: 1, label: '1 — Must watch', shortLabel: 'P1' },
  { value: 2, label: '2 — High', shortLabel: 'P2' },
  { value: 3, label: '3 — Medium', shortLabel: 'P3' },
  { value: 4, label: '4 — Low', shortLabel: 'P4' },
  { value: 5, label: '5 — Someday', shortLabel: 'P5' },
]
